...
#list inside list
list_nest = [10,20,30,40,50,["python","java","cloud","devops","html"]]
...
#list_nums.append(70,80) #TypeError: list.append() takes exactly one argument (2 given)
...
# 2 extend() -> can add only iterables, so elements are added as individuals,not as nested
list_nums = [10,20,30,40,50]
print(list_nums)
...
# 4 pop() -> removes an element,by default removes last element
list_nums = [10,20,30,40,50]
print(list_nums)
...
# 5 remove() -> remooves the matching value,not based on index
...
# print(list_nums.index(60)) # ValueError: 60 is not in list

list_nums = [10,20,30,20,40,20,10,20,10,20,10]
print(list_nums.index(20,2)) # start
print(list_nums.index(20,4,8)) # start and stop
...
# slicing reverse the elements of the list and don't update the original list
list_nums = [10,20,30,40,50]
print(list_nums)
print(list_nums[::-1])
print(list_nums)
...
names = ["pranay","ghanta","ram"]
names.sort()
print(names)

mixed_data = ["pranay","ghanta","ram",2,3]
# mixed_data.sort() # mixed data cannot be sorted
print(mixed_data)

# 11 copy() -> creates a shallow copy,meaning when we modify the shallow copy original copy will not affect
list_nums = [10,30,20,40,50]
print(list_nums)
